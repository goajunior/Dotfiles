...
if !exists("python_no_builtin_highlight")
  ...
  syn keyword pythonBuiltin	solve plot interactive
  syn keyword pythonBuiltin	UnitSquareMesh
  syn keyword pythonBuiltin	FunctionSpace TrialFunction TestFunction Function 
  syn keyword pythonBuiltin	inner Constant DirichletBC dot empty array norm transpose zeros
  syn keyword pythonBuiltin	float float64 int int32 int64
